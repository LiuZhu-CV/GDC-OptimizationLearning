...
class ResidualDenseBlock(nn.Module):
    def __init__(self, in_channels,kernel_size,dialtions=1, bias=False):
      ...
      self.conv1 = BasicConv(in_channels,in_channels,kernel_size, dilation=dialtions, relu=False,groups=in_channels)
      self.conv2 = BasicConv(in_channels*2,in_channels,kernel_size, dilation=dialtions, relu=False,groups=in_channels)
      self.conv3 =BasicConv(in_channels*3,in_channels,kernel_size, dilation=dialtions, relu=False,groups=in_channels)
